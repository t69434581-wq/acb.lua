...
local filename = name .. "_" .. time .. ".lua"
writefile(filename, obj.Source)
print("Saved: " .. filename)
else
local filename = name .. "_" .. time .. ".rbxm"
local clone = obj:Clone()
clone.Parent = nil
local json = game:GetService("HttpService"):JSONEncode({ClassName = obj.ClassName, Name = obj.Name})
